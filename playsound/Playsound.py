...
sng_frame = LabelFrame(windows, text="Song Track", bg="blue")
...
songstatus = Label(sng_frame, textvariable=status, font="bold", bg="lime")
songstatus.grid(row=0, column=1, padx=10, pady=5)

cntrl_panel = LabelFrame(windows, text="Control Panel", width=250, height=100, bg="blue")
cntrl_panel.place(x=0, y=100, width=600, height=100)

sng_lst = LabelFrame(windows, text="Song List", width=250, height=200, bg="lime")
